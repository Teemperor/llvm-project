...
public:
    ...
    * Objective-C: Same as in C.
    ...
    %feature("docstring",
    "Returns the number of fields of the current type.
    ...
    * Objective-C: Same as in C for structs. For Objective-C classes the number
    ...
    %feature("docstring",
    "Returns the number of base/parent classes of the current type.
    ...
    * Objective-C: The number of super classes for Objective-C classes.
    ...
    %feature("docstring",
    "Returns the number of virtual base/parent classes of the current type
    ...
    * Objective-C: Same as in C.
    ...
    %feature("docstring",
    "Returns the number of template arguments of the current type.
