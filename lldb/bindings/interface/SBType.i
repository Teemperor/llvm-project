...
public:
    ...
    * Objective-C: Returns false for all types.
    ...
    %feature("docstring",
    "Returns an `SBType` that represents a pointer to this type.

    If the type system of the current language can't represent a pointer to this
    type or the current type is invalid, an invalid `SBType` is returned.

    Language-specific behaviour:

    * C: Returns the pointer type of the current type.
    * C++: Same as in C.
    * Objective-C: Same as in C.
    ") GetPointerType;
    lldb::SBType
    ...
    * Objective-C: Same as in C. The pointee type of ``id`` and ``Class`` is
    ...
    %feature("docstring",
    "Returns an `SBType` that represents a reference to this type.
    ...
    * Objective-C: Same as in C.
    ...
    %feature("docstring",
    "Returns the array element type if the current type is an array type.
    ...
    * Objective-C: Same as in C.
    ...
    %feature("docstring",
    "Returns the vector element type if the current type is a vector type.
    ...
    * Objective-C: Same as in C.
    ...
    %feature("docstring",
    "Returns the number of fields in the current type or ``0`` if this type does
    not have fields.
    ...
    * Objective-C: Same as in C for structs. For Objective-C classes the number
    ...
    %feature("docstring",
    "Returns the number of base/parent classes in the current type or ``0`` if
    this type doesn't have any base classes.

    Language-specific behaviour:

    * C: Returns always ``0``.
    * C++: The number of direct non-virtual base classes if the current type is
      a class.
    * Objective-C: The number of super classes for Objective-C classes.
    ...
    %feature("docstring",
    "Returns the number of virtual base/parent classes in the current type or
    ``0`` if this type doesn't have any base classes.

    Language-specific behaviour:

    * C: Returns always ``0``.
    * C++: The number of direct virtual base classes if the current type is a
      class.
    * Objective-C: Returns always ``0``.
    ...
    %feature("docstring",
    "The field at the given index or an invalid `SBType` if the index is
    out of range or the current type doesn't have any fields.
    ...
    * Objective-C: Same as in C for structs. For Objective-C classes the ivar
    ...
    Returns an empty string if an error occurred or the current type is invalid.
    ...
    * Objective-C: Same as in C.
    ...
    %feature("docstring",
    "Returns the `TypeClass` for this type or an `eTypeClassInvalid`
     if this `SBType` is invalid.
    ...
    %feature("docstring",
    "The number of template arguments of the current type. Returns ``0`` if
    this type is not a template.
    ...
    * Objective-C: Always returns ``0``.
    ...
    %feature("docstring",
    "The type of the template argument with the given index. Returns an invalid
    `SBType` if there is no template argument with the given index or this type
    is not a template. The first template  argument has the index ``0``.
    ...
    * Objective-C: Always returns an invalid SBType.
    ...
    %feature("docstring",
    "The kind of the template argument with the given index. Returns
    `eTemplateArgumentKindNull` if there is no template argument
    with the given index or this type is not a template. The first
    template argument has the index ``0``.
    ...
    * Objective-C: Always returns `eTemplateArgumentKindNull`.
    ...
    %feature("docstring",
    "Returns the return type if this type represents is a function.
    ...
    * C: Always returns ``0``.
    * C++: If the current type represents a struct/class, then the number of
    ...
    * Objective-C: If the current type represents a struct/class, then the
    ...
    * Objective-C: Returns the method with the given index.
    ...
    %feature("docstring",
    "Computes the `TypeFlags` values for this type.
    ...
    If the current type is invalid this returns ``0``.
