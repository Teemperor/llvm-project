...
class TestCase(TestBase):
    def test(self):
        ...
        # Check the different "shapes" of the double type: array, pointer,
        ...
        self.expect_var_path("the_double_ref", type="double &")
        self.expect_expr("the_double_ref", result_type="double", result_value="6.25")
        ...
        self.expect_var_path("the_float_class.m_a", type="float", value="7.5")
        self.expect_var_path("the_float_class.m_b", type="double", value="8.25")
        self.expect_expr("the_float_class.m_a", result_type="float", result_value="7.5")

        self.expect_var_path("the_float_class_ptr->m_a", type="float", value="7.5")
        self.expect_var_path("the_float_class_ref.m_b", type="double", value="8.25")
