...
class TestCase(TestBase):
    ...
    def test_access_from_main(self):
        ...
        self.expect_expr("my_a.m_d", result_type="char", result_value="3")
        self.expect_expr("my_a.s_d", result_type="int", result_value="4")
    ...
    def test_access_from_member_function(self):
        ...
        self.expect_expr("m_d", result_type="char", result_value="3")
        self.expect_expr("s_d", result_type="int", result_value="4")
    ...
    def test_access_without_scope(self):
        ...
        self.expect("expression s_d", error=True,
