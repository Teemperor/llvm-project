...
class CxxWCharTTestCase(TestBase):
    ...
    def test(self):
        ...
        self.expect_var_path("foo_y", result_type="Foo<wchar_t>")

        # Check that we correctly report templates on int
        self.expect_var_path("foo_x", result_type="Foo<int>")

        # Check that we correctly report wchar_t
        self.expect_var_path("foo_y.object", result_type="wchar_t")

        # Check that we correctly report int
        self.expect_var_path("foo_x.object", result_type="int")
