...
class TestCase(TestBase):
    def test(self):
        ...
        # Variant 1: recursion through the named struct 's1'. Completing 't1'
        # and walking one level into its members must not recurse infinitely.
        ...
        # Variant 2: recursion through an anonymous struct member.
