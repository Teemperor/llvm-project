...
class ClassEmptyMember { int i[0]; };
...
int main() {
  ...
  return sizeof_empty + sizeof_empty_class + sizeof_class_empty_member + sizeof_single +
    + sizeof_empty_class_aligned + sizeof_single_class + sizeof_padding + sizeof_padding_class;
}
