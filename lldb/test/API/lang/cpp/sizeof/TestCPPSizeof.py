...
class TestCase(TestBase):
    ...
    def test(self):
        ...
        self.expect_expr("sizeof(EmptyClassAligned) == sizeof_empty_class_aligned", result_value="true")
        self.expect_expr("sizeof(ClassEmptyMember) == sizeof_class_empty_member", result_value="true")
