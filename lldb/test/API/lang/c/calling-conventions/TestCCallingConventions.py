...
class TestCase(TestBase):
    ...
    def build_and_run(self, test_file):
        ...
        try:
            self.build(dictionary={
             ...
             # Test source filed to build. Check if it failed because the
    ...
    # On Linux we mangle `func` as just `func` instead of `func@@<byte-count>`.
    @expectedFailureAll(oslist=no_match(['linux']))
