...
class LibcxxMapDataFormatterTestCase(TestBase):
    ...
    def check_pair(self, first_value, second_value):
        pair_children = [self.ValueCheck(expect_name="first", expect_value=first_value),
                         self.ValueCheck(expect_name="second", expect_value=second_value)]
        return self.ValueCheck(children=pair_children)
