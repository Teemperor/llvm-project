...
class LaunchWithShellExpandTestCase(TestBase):
    ...
    def test(self):
        ...
        self.expect_var_path("argv[1]", result_summary='"file1.txt"')
        self.expect_var_path("argv[2]", result_summary='"file2.txt"')
        self.expect_var_path("argv[3]", result_summary='"file3.txt"')
        self.expect_var_path("argv[4]", result_summary='"file4.txy"')
        self.expect_var_path("argv[5]", result_summary='"()"')
        self.expect_var_path("argv[6]", result_summary='">"')
        self.expect_var_path("argv[7]", result_summary='"<"')
        self.expect_var_path("argc", result_value='8')
