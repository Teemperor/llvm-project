...
class TestBasicList(TestBase):
    ...
    def test(self):
        ...
        self.expect_expr("op_global_map.at(1)", result_value="2")
        self.expect_expr("op_global_map.at(2)", result_value="4")
        self.expect_expr("op_global_map[1]", result_value="2")
        self.expect_expr("op_global_map[2]", result_value="4")
        self.expect_expr("op_global_map.size()", result_value="2")
        self.expect_expr("op_global_map.empty()", result_value="false")
        self.runCmd("expr op_global_map.clear()")
        self.expect_expr("op_global_map.empty()", result_value="true")
