...
//===----------------------------------------------------------------------===//
//
// Rendering a cpp_typesystem type back to its source spelling. Two names are
...
#ifndef LLDB_SOURCE_PLUGINS_TYPESYSTEM_CPP_TYPE_NAME_H
#define LLDB_SOURCE_PLUGINS_TYPESYSTEM_CPP_TYPE_NAME_H
...
/// from \p t first (see TypeSystemCpp::CompleteTemplateInstantiationForName):
...
#endif // LLDB_SOURCE_PLUGINS_TYPESYSTEM_CPP_TYPE_NAME_H
