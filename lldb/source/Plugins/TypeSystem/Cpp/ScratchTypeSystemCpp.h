...
#ifndef LLDB_SOURCE_PLUGINS_TYPESYSTEM_CPP_SCRATCHTYPESYSTEMCPP_H
#define LLDB_SOURCE_PLUGINS_TYPESYSTEM_CPP_SCRATCHTYPESYSTEMCPP_H
...
/// The per-Target TypeSystemCpp: the one that owns types that aren't tied to
...
/// `symbols.enable-typesystem-cpp` is on, which is how TypeSystemCpp
...
#endif // LLDB_SOURCE_PLUGINS_TYPESYSTEM_CPP_SCRATCHTYPESYSTEMCPP_H
