...
public:
  ...
  /// triple via Clang's target knowledge.
  struct BuiltinSizes {
  ...
  /// The language options for \p triple, with the builtin type sizes and float
  /// formats derived from Clang's knowledge of that target.
  ///
  /// Returns an error if Clang cannot describe the triple.
