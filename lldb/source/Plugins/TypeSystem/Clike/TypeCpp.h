...
#ifndef LLDB_SOURCE_PLUGINS_TYPESYSTEM_CLIKE_TYPE_CPP_H
#define LLDB_SOURCE_PLUGINS_TYPESYSTEM_CLIKE_TYPE_CPP_H
...
/// DWARFASTParserClike::CompleteMemberFunctionsFromDWARF).
...
#endif // LLDB_SOURCE_PLUGINS_TYPESYSTEM_CLIKE_TYPE_CPP_H
