...
#ifndef LLDB_SOURCE_PLUGINS_TYPESYSTEM_CLIKE_TYPE_OBJC_H
#define LLDB_SOURCE_PLUGINS_TYPESYSTEM_CLIKE_TYPE_OBJC_H
...
/// TypeSystemClike::GetChildCompilerTypeAtIndex). The field byte_offset stored
...
#endif // LLDB_SOURCE_PLUGINS_TYPESYSTEM_CLIKE_TYPE_OBJC_H
