  ...
  if (log) {
    if (!context.m_decl_context)
      ...
      LLDB_LOG(log,
                ...
                "'{0}' in '{1}'",
                name,
                context_named_decl->getNameAsString());
    else
      LLDB_LOG(log,
                "ClangExpressionDeclMap::FindExternalVisibleDecls for "
                "'{0}' in a '{1}'",
...
void ClangExpressionDeclMap::AddOneFunction(NameSearchContext &context,
  ...
  if (function) {
    ...
    if (copied_function_type) {
      ...
      LLDB_LOG(log, "  Failed to import the function type '{0}' ({1:x})"
...
void ClangExpressionDeclMap::AddOneType(NameSearchContext &context,
  ...
  if (!copied_clang_type) {
    ...
    LLDB_LOG( log, "ClangExpressionDeclMap::AddOneType - Couldn't import the type");
