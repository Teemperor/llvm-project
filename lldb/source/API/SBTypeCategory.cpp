...
uint32_t SBTypeCategory::GetNumFormats() {
  ...
  return m_opaque_sp->GetFormatsContainer().GetCount() +
         m_opaque_sp->GetFormatsContainer().GetCount();
}
...
uint32_t SBTypeCategory::GetNumSummaries() {
  ...
  if (!IsValid())
    return 0;
  return m_opaque_sp->GetSummariesContainer().GetCount() +
         m_opaque_sp->GetSummariesContainer().GetCount();
}
...
uint32_t SBTypeCategory::GetNumFilters() {
  ...
  if (!IsValid())
    return 0;
  return m_opaque_sp->GetFiltersContainer().GetCount() +
         m_opaque_sp->GetFiltersContainer().GetCount();
}
...
uint32_t SBTypeCategory::GetNumSynthetics() {
  ...
  if (!IsValid())
    return 0;
  return m_opaque_sp->GetSyntheticsContainer().GetCount() +
         m_opaque_sp->GetSyntheticsContainer().GetCount();
}
...
SBTypeFilter SBTypeCategory::GetFilterForType(SBTypeNameSpecifier spec) {
  ...
  if (spec.IsRegex())
    m_opaque_sp->GetFiltersContainer().GetExact(
...
SBTypeFormat SBTypeCategory::GetFormatForType(SBTypeNameSpecifier spec) {
  ...
  if (spec.IsRegex())
    m_opaque_sp->GetFormatsContainer().GetExact(
...
SBTypeSummary SBTypeCategory::GetSummaryForType(SBTypeNameSpecifier spec) {
  ...
  if (spec.IsRegex())
    m_opaque_sp->GetSummariesContainer().GetExact(
...
SBTypeSynthetic SBTypeCategory::GetSyntheticForType(SBTypeNameSpecifier spec) {
  ...
  if (spec.IsRegex())
    m_opaque_sp->GetSyntheticsContainer().GetExact(
        ConstString(spec.GetName()), children_sp);
  else
    m_opaque_sp->GetSyntheticsContainer().GetExact(
        ConstString(spec.GetName()), children_sp);
...
bool SBTypeCategory::AddTypeFormat(SBTypeNameSpecifier type_name,
  ...
  if (type_name.IsRegex())
    m_opaque_sp->GetFormatsContainer().Add(
        RegularExpression(
...
bool SBTypeCategory::DeleteTypeFormat(SBTypeNameSpecifier type_name) {
  ...
  if (type_name.IsRegex())
    return m_opaque_sp->GetFormatsContainer().Delete(
...
bool SBTypeCategory::AddTypeSummary(SBTypeNameSpecifier type_name,
  ...
  if (type_name.IsRegex())
    m_opaque_sp->GetSummariesContainer().Add(
        RegularExpression(
            llvm::StringRef::withNullAsEmpty(type_name.GetName())),
        summary.GetSP());
  else
...
bool SBTypeCategory::DeleteTypeSummary(SBTypeNameSpecifier type_name) {
  ...
  if (type_name.IsRegex())
    return m_opaque_sp->GetSummariesContainer().Delete(
        ConstString(type_name.GetName()));
  else
    return m_opaque_sp->GetSummariesContainer().Delete(
        ConstString(type_name.GetName()));
...
bool SBTypeCategory::AddTypeFilter(SBTypeNameSpecifier type_name,
  ...
  if (type_name.IsRegex())
    m_opaque_sp->GetFiltersContainer().Add(
        RegularExpression(
            llvm::StringRef::withNullAsEmpty(type_name.GetName())),
        filter.GetSP());
  else
...
bool SBTypeCategory::DeleteTypeFilter(SBTypeNameSpecifier type_name) {
  ...
  if (type_name.IsRegex())
    return m_opaque_sp->GetFiltersContainer().Delete(
        ConstString(type_name.GetName()));
  else
    return m_opaque_sp->GetFiltersContainer().Delete(
        ConstString(type_name.GetName()));
...
bool SBTypeCategory::AddTypeSynthetic(SBTypeNameSpecifier type_name,
  ...
  if (type_name.IsRegex())
    m_opaque_sp->GetSyntheticsContainer().Add(
        RegularExpression(
            llvm::StringRef::withNullAsEmpty(type_name.GetName())),
        synth.GetSP());
  else
...
bool SBTypeCategory::DeleteTypeSynthetic(SBTypeNameSpecifier type_name) {
  ...
  if (type_name.IsRegex())
    return m_opaque_sp->GetSyntheticsContainer().Delete(
        ConstString(type_name.GetName()));
  else
    return m_opaque_sp->GetSyntheticsContainer().Delete(
        ConstString(type_name.GetName()));
