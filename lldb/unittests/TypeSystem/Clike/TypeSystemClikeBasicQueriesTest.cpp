//===-- TypeSystemClikeBasicQueriesTest.cpp -------------------------------===//
//
...
namespace {
struct TypeSystemClikeBasicQueriesTest : public testing::Test {
...
TEST_F(TypeSystemClikeBasicQueriesTest, IsAggregateType) {
...
TEST_F(TypeSystemClikeBasicQueriesTest, IsCharType) {
...
TEST_F(TypeSystemClikeBasicQueriesTest, IsCharTypeThroughSugar) {
...
// does not.
TEST_F(TypeSystemClikeBasicQueriesTest, IsFloatingPointType) {
...
TEST_F(TypeSystemClikeBasicQueriesTest, IsFunctionType) {
...
TEST_F(TypeSystemClikeBasicQueriesTest, IsFunctionPointerType) {
...
TEST_F(TypeSystemClikeBasicQueriesTest, IsBlockPointerType) {
  CompilerType fn = builder.CreateFunctionType(GetVoid(), false);
...
TEST_F(TypeSystemClikeBasicQueriesTest, IsIntegerType) {
...
// type.
TEST_F(TypeSystemClikeBasicQueriesTest, EnumerationQueries) {
...
TEST_F(TypeSystemClikeBasicQueriesTest, IsPointerType) {
...
TEST_F(TypeSystemClikeBasicQueriesTest, IsScalarType) {
...
TEST_F(TypeSystemClikeBasicQueriesTest, IsVoidType) {
...
TEST_F(TypeSystemClikeBasicQueriesTest, IsPossibleDynamicTypePolymorphic) {
  CompilerType poly = builder.CreateRecordType("Poly", 8, true);
  auto *poly_class =
      llvm::cast<ClassType>(static_cast<clike::Type *>(poly.GetOpaqueQualType()));
  ...
  builder.SetRecordComplete(
      *llvm::cast<ClassType>(static_cast<clike::Type *>(plain.GetOpaqueQualType())));
