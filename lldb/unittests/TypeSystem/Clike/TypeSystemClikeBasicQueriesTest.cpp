...
TEST_F(TypeSystemClikeBasicQueriesTest, IsPossibleDynamicTypePolymorphic) {
  ...
  auto *poly_class =
      llvm::cast<ClassType>(static_cast<clike_typesystem::Type *>(poly.GetOpaqueQualType()));
  ...
  builder.SetRecordComplete(
      *llvm::cast<ClassType>(static_cast<clike_typesystem::Type *>(plain.GetOpaqueQualType())));
