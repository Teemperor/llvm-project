...
namespace {
struct TypeSystemCppChildrenTest : public testing::Test {
  ...
  CompilerType MakeSimpleRecord() {
    ...
    builder.AddField(*r, builder.GetIdentifier("b"),
                     static_cast<cpp_typesystem::Type *>(GetInt().GetOpaqueQualType()), 4);
...
// offset.
TEST_F(TypeSystemCppChildrenTest, RecordChildren) {
...
// offset.
TEST_F(TypeSystemCppChildrenTest, ArrayChildren) {
...
// deref child.
TEST_F(TypeSystemCppChildrenTest, TransparentPointerToCompleteAggregate) {
  CompilerType record = MakeSimpleRecord();
...
TEST_F(TypeSystemCppChildrenTest, PointerToScalarHasSingleDerefChild) {
...
TEST_F(TypeSystemCppChildrenTest, NonTransparentPointerDerefsToWholeAggregate) {
  CompilerType record = MakeSimpleRecord();
  CompilerType ptr = builder.CreatePointerType(record);
...
TEST_F(TypeSystemCppChildrenTest, GetIndexOfChildWithName) {
  CompilerType record = MakeSimpleRecord();
  auto idx =
...
TEST_F(TypeSystemCppChildrenTest, GetIndexOfChildWithNameNotFound) {
  CompilerType record = MakeSimpleRecord();
...
TEST_F(TypeSystemCppChildrenTest, EmptyBaseClassOmitted) {
  ...
  builder.AddBaseClass(
      *derived_class, static_cast<cpp_typesystem::Type *>(empty_base.GetOpaqueQualType()), 0);
