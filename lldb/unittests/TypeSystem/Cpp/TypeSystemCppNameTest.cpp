...
namespace {
struct TypeSystemCppNameTest : public testing::Test {
...
TEST_F(TypeSystemCppNameTest, BuiltinName) {
...
TEST_F(TypeSystemCppNameTest, PointerAndReferenceNames) {
...
// the count.
TEST_F(TypeSystemCppNameTest, ArrayNames) {
...
// TypeSystemClang).
TEST_F(TypeSystemCppNameTest, CVQualifiedNames) {
...
TEST_F(TypeSystemCppNameTest, TemplateDisplayNameHidesDefaultArgs) {
  ...
  builder.AddTemplateArgument(
      *r, lldb::eTemplateArgumentKindType,
      static_cast<cpp_typesystem::Type *>(allocator.GetOpaqueQualType()), 0,
      /*is_default=*/true);
