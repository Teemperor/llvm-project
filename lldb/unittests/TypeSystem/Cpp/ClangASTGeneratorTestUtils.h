...
#ifndef LLDB_UNITTESTS_TYPESYSTEM_CPP_CLANGASTGENERATORTESTUTILS_H
#define LLDB_UNITTESTS_TYPESYSTEM_CPP_CLANGASTGENERATORTESTUTILS_H
...
public:
  ...
  cpp_typesystem::Builder builder{*ts};
