  ...
  public:
    ...
    public:
      StdModuleScope(Minion &minion, clang::ASTContext *dst_ctx)
          : m_minion(minion) {
        // If the minion doesn't have a StdModuleHandler yet, create one
        // and attach it.
