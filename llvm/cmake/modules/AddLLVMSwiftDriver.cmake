...
#
# Defines llvm_add_swift_driver_external_project(root) which creates four
...
#
# Parameters:
#   root  – directory that contains swift-driver/, llbuild/,
#           swift-tools-support-core/, swift-argument-parser/ as siblings.
...
function(llvm_add_swift_driver_external_project root)
  ...
  set(_driver_dst     "${CMAKE_BINARY_DIR}/bin/swift-driver")
  ...
  # -------------------------------------------------------------------------
  # 2. swift-argument-parser (no heavy dependencies)
  # -------------------------------------------------------------------------
  ...
  # -------------------------------------------------------------------------
  # 3. swift-tools-support-core (depends on llbuild)
  # -------------------------------------------------------------------------
